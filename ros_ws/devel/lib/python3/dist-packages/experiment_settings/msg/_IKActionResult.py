...
"""autogenerated by genpy from experiment_settings/IKActionResult.msg. Do not edit."""
import codecs
import sys
...
class IKActionResult(genpy.Message):
  _md5sum = "0989a3a9682d4c67ebce178b879cb33c"
  _type = "experiment_settings/IKActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','experiment_settings/IKResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IKActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = experiment_settings.msg.IKResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = experiment_settings.msg.IKResult()
