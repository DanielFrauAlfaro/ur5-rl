...
"""autogenerated by genpy from experiment_settings/IKActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class IKActionFeedback(genpy.Message):
  _md5sum = "d55bf109107cc4e4608c14ec0a33e345"
  _type = "experiment_settings/IKActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','experiment_settings/IKFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IKActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = experiment_settings.msg.IKFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = experiment_settings.msg.IKFeedback()
