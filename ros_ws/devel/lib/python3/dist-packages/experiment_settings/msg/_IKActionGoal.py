...
"""autogenerated by genpy from experiment_settings/IKActionGoal.msg. Do not edit."""
import codecs
import sys
...
class IKActionGoal(genpy.Message):
  _md5sum = "83a5003608bfe9186a54ce300336432e"
  _type = "experiment_settings/IKActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','experiment_settings/IKGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = experiment_settings.msg.IKGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = experiment_settings.msg.IKGoal()
