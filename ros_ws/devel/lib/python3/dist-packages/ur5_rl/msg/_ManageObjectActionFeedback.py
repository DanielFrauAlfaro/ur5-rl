...
"""autogenerated by genpy from ur5_rl/ManageObjectActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class ManageObjectActionFeedback(genpy.Message):
  _md5sum = "b504ebfe76fe3613861559551a618af9"
  _type = "ur5_rl/ManageObjectActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ur5_rl/ManageObjectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ManageObjectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ur5_rl.msg.ManageObjectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ur5_rl.msg.ManageObjectFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feed,) = _get_struct_i().unpack(str[start:end])
      return self
