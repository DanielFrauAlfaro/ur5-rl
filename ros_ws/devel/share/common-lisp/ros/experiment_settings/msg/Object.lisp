...
(cl:defmethod cl:initialize-instance :after ((m <Object>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Object)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name experiment_settings-msg:<Object> is deprecated: use experiment_settings-msg:Object instead.")))
...
(cl:ensure-generic-function 'chosenObject-val :lambda-list '(m))
(cl:defmethod chosenObject-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiment_settings-msg:chosenObject-val is deprecated.  Use experiment_settings-msg:chosenObject instead.")
  (chosenObject m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiment_settings-msg:pose-val is deprecated.  Use experiment_settings-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <Object>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader experiment_settings-msg:orientation-val is deprecated.  Use experiment_settings-msg:orientation instead.")
  (orientation m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Object>) ostream)
  "Serializes a message object of type '<Object>"
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'header) ostream)
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'chosenObject))))
  ...
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) ele))
   (cl:slot-value msg 'chosenObject))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Object>) istream)
  ...
  (cl:setf (cl:slot-value msg 'chosenObject) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'chosenObject)))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Object>)))
  ...
  (cl:format cl:nil "Header header~%string[] chosenObject~%geometry_msgs/Point[] pose~%geometry_msgs/Point[] orientation~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Object)))
  "Returns full string definition for message of type 'Object"
  (cl:format cl:nil "Header header~%string[] chosenObject~%geometry_msgs/Point[] pose~%geometry_msgs/Point[] orientation~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Object>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'chosenObject) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4 (cl:length ele))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Object>))
  ...
  (cl:list 'Object
    ...
    (cl:cons ':chosenObject (chosenObject msg))
