...
class IKActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IKGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IKActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = IKGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new IKGoal()
    }
