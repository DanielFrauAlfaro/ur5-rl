...
class IKActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IKFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new IKActionFeedback(null);
    ...
    data.feedback = IKFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IKActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = IKFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new IKFeedback()
    }
...
module.exports = IKActionFeedback;
