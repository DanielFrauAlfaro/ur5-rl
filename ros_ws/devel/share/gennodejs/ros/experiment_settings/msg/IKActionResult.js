...
class IKActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = IKResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IKActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = IKResult.Resolve(msg.result)
    }
    else {
      resolved.result = new IKResult()
    }
