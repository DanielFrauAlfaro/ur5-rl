...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/ros_control/rqt_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/ros_control/rqt_controller_manager/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/ros_control/rqt_controller_manager \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/ros_control/rqt_controller_manager" \
    install \
    --root="${DESTDIR-/}" \
