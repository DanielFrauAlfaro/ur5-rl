...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/allegro-hand-ros/allegro_hand"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/allegro-hand-ros/allegro_hand/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/allegro-hand-ros/allegro_hand \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/allegro-hand-ros/allegro_hand" \
    install \
    --root="${DESTDIR-/}" \
