...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/vision_opencv/cv_bridge/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/vision_opencv/cv_bridge \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
