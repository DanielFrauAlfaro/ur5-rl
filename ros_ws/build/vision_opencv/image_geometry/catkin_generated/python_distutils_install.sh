...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/vision_opencv/image_geometry/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/vision_opencv/image_geometry \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
