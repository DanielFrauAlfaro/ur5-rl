...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_2f_gripper_control/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_2f_gripper_control \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
