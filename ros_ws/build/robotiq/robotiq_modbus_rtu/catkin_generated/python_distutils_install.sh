...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_modbus_rtu/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_modbus_rtu \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
