...
echo_and_run cd "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/daniel/Desktop/ur5-rl/ros_ws/src/robotiq/robotiq_modbus_tcp/setup.py" \
    egg_info --egg-base /daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_modbus_tcp \
    build --build-base "/daniel/Desktop/ur5-rl/ros_ws/build/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
